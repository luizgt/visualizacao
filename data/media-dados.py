...
arquivoFonte = "./scorers/BestScorers.csv"
arq = open("./scorers/Best-AVG.csv","w")
# arq.write("RANK;SHIRTNUMBER;NAME;TEAM;RUNNING SETS;FAULTS;STILL SETS;TOTAL ATTEMPTS;AVERAGE PER SET\n")
